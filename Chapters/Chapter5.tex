...
\todo{Comparison of overall model performance. Perform statistical analysis, e.g. ANOVA, Tukey's HSD.}

\section{Comparison of Loss Functions}
Analyze how different loss functions impact performance. 
Use visualizations to compare results.
Use statistical significance to validate whether a loss function is better than the other.
...
\begin{itemize}
    \item Run multiple of the same training to check for variance. What could this tell us in terms of statistical significance?
