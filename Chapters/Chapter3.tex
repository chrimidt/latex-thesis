...
The implementation details for the balanced softmax loss can be viewed in algorithm \ref{alg:balanced_softmax_loss} in appendix \ref{app:implementation}. \todo{just reference the paper.}
