...
This section will discuss the selection of the four backbone architectures ResNet50, MobileNetV2, ViT-B/16, and ConvNeXt-Base. 

These models were chosen based on their suitability for image classification tasks and high performance on benchmarks. The CNN based architectures utilize convolutional layers to extract features while preserving the spacial relationships of pixels in 2D images, as described in section \ref{sec:CNNs}. 

% The chosen models represent a diverse set of architectures, each offering unique strengths in terms of feature extraction, computational efficiency, and adaptability to imbalance-aware methods.
...
\begin{table}[ht]
    ...
    81.072 \cite{torchvision2024vitb16}\\
...
PyTorch \cite{torchvision-resnet} \todo{check the correct version}.
