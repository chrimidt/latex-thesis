...
For validation, a simpler approach was used, where images were resized to $224\times 224$ pixels and normalized using the same mean and standard deviation values as the training set.
