...
PyTorch \cite{pytorch_resnet50} \todo{check the correct version}.
...
\paragraph{ViT-B/16}
The introduction of ViTs in 2021 \cite{dosovitskiy2021imageworth16x16words} suddently changed the status of CNNs as the state-of-the-art image classification architecture \cite{liu2022convnet2020s}. 
...
The implementation details for the balanced softmax loss can be viewed in algorithm \ref{alg:balanced_softmax_loss} in appendix \ref{app:implementation}.
...
Describe how the models are compared, e.g. with top-1 accuracy. Reference articles in image classification tasks and how they compare.
...
Describe the choice of the custom split of the CIFAR-100 dataset.

Describe here the implementation of EQ Loss.
