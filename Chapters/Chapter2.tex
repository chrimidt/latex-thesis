...
The CE loss measures the difference between the predicted probability distribution $P$ and the true class label $y$, defined as \cite{zhang2023dive,cs231n}:
...
\begin{equation}
    \mathcal{L}_{\text{CE}} = - \log\left(\frac{\exp(z_i)}{\sum_{j=1}^{K} \exp(z_j)}\right)
\end{equation}
